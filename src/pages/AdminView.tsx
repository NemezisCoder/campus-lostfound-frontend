          ...
          {!detail ? (
            ...
            <>
              <div className={styles.card}>
                ...
                <div className={styles.row}>
                  <b>Объявление:</b> {detail.item_title ?? `Item #${detail.item_id}`} •{" "}
                  {detail.item_status}
                </div>
                <div className={styles.row}>
                  <b>Пожаловался:</b> {detail.reporter.name} {detail.reporter.surname} (id{" "}
                  {detail.reporter.id})
                </div>
                <div className={styles.row}>
                  <b>На кого:</b> {detail.reported.name} {detail.reported.surname} (id{" "}
                  {detail.reported.id})
                </div>
